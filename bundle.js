            ...
            if (Symbol.iterator in Object(e))
                return function(e, t) {
                    ...
                    let i, s = !0,
                        n = !1;
                    try {
                        for (var a, r = e[Symbol.iterator](); !(s = (a = r.next()).done) && (o.push(a.value), !t || o.length !== t); s = !0)
                        ;
                    } catch (e) {
                        n = !0,
                            i = e
...
((s, r, h) => {
    const c = new((() => {
        function e() {
            _classCallCheck(this, e), !localStorage.getItem("version") && localStorage.setItem("version", "5.4.0 (9)"),
                this.old = `HSLO532-`,
                this.latest = `HSLO540-`,
        ...
        return _createClass(e, [{
                ...
                value() {
                    this.isOpened = !1,
                        ...
                        this.rainbowBorder = c.get("settings", "rainbowBorder") || "on",
                ...
                value(e, t) {
                    let cancelled = !1;
                    this[e] = t,
                        "multiboxMode" === e && A.isAliveTab2 && (m.alert("HSLO", `Tab 2 must not be alive`), this.multiboxMode = "on", c.set("settings", "multiboxMode", "on"), cancelled = !0, this.setDomValues()), !A.isAliveTab2 && "multiboxMode" === e && m.alert("HSLO", `Multibox mode [${this.multiboxMode.toUpperCase()}]`), !A.isAliveTab2 && "multiboxMode" === e && (this.multiboxMode === "off" ? (q.Tab2.close(),
                            q.Tab2 = null,
                            j.protocolKey2 = null,
                            j.clientKey2 = null,
                            Q.loggedIn2 = !1,
                            ...
                            this.setDomValues())), !A.isAliveTab2 && "multiboxMode" === e && (this.multiboxMode === "off" ? (J.ogarWS2.close(),
                            J.ogarWS2 = null) : (
                            ae.connectedIndex = 1,
                        ...
                        "spySaigo" === e && (m.alert("HSLO", `Fullzoom [${this.spySaigo.toUpperCase()}]`),
                        ...
                        "primaryGoogle" === e && (A.isAlive ? (m.alert("HSLO", "You can't be alive!"),
                            ...
                            ee.logout(),
                            q.reconnect(1),
                            q.reconnect(2))), !cancelled && c.set("settings", e, t),
                        "foodGlow" === e && H.init(),
                        "virusGlow" === e && de.init(),
            ...
            return _createClass(e, [{
                    ...
                    value() {
                        ...
                        e || (e = {
                                ...
                                skin: "https://i.imgur.com/HDtlcHJ.png",
                                skin2: "https://i.imgur.com/HDtlcHJ.png"
                            }),
    ...
    window.classb = b,
        a = (() => {
            ...
            return _createClass(e, null, [{
                    ...
                    value(e) {
                        ...
                        if (t && !this.pressedKeys.has(t) && (this.pressedKeys.set(t, !0), !x.isOpened || "hotkeys" !== x.target)) {
                            if (t === this.chatKey)
                                return void d.chat();
                            if (!w.isFocused) {
                    ...
                    value(e) {
                        ...
                        return e.ctrlKey ? o = "CTRL+" : e.altKey && (o = "ALT+"),
                            64 < t && 91 > t ? i = String.fromCharCode(t) : 47 < t && 58 > t ? i = "" + (t - 48) : o || (13 === t ? i = "ENTER" : 27 === t ? i = "ESC" : 32 === t ? i = "SPACE" : 16 === t ? i = "SHIFT" : 9 === t ? i = "TAB" : 46 === t ? i = "DEL" : 38 === t ? i = "UP" : 40 === t ? i = "DOWN" : 37 === t ? i = "LEFT" : 39 === t ? i = "RIGHT" : 192 === t && (i = "TILDE")), !!i && (o ? o + i : i)
                    }
                }]),
                e
        })(),
        _ = new((() => {
            ...
            return _createClass(e, [{
                    ...
                    value(e) {
                        ...
                        L.targetViewport = t*/
                        let t = L.targetViewport;
                        if (e.wheelDelta < 0) t *= settings.zoomSpeed / 100;
                        else t /= settings.zoomSpeed / 100;
                        t = (t > 2) ? 2 : (t <
                            0.02) ? 0.02 : t;
                        L.targetViewport = t;
                    }
        ...
        d = (() => {
            ...
            return _createClass(e, null, [{
                    ...
                    key: "multiboxTab",
                    value() {
                        1 === A.controllingTab ? (A.controllingTab = 2, !A.isAliveTab2 && (Q.myTurn = true, Q.spawn())) : (A.controllingTab = 1, !A.isAliveTab1 && (Q.myTurn = true, Q.spawn()))
                    }
                }]),
                e
        })(),
            ...
            return _createClass(e, null, [{
                        ...
                        value() {
                            this.isOpened = !1,
                                ...
                                this.commanderColor = c.get("theme", "commanderColor") || "#000",
                                ...
                                this.maouCircleSkinURL = c.get("theme", "maouCircleSkinURL") || "https://i.imgur.com/PzeEunA.png",
                                this.everyoneSkinsURL = c.get("theme", "everyoneSkinsURL") || "https://i.imgur.com/oUiAr5m.png",
                                this.multiboxShieldURL = c.get("theme", "multiboxShieldURL") || "https://i.imgur.com/HV0ZAhi.png",
    ...
    S = new((() => {
            ...
            return _createClass(e, [{
                    ...
                    value(e, t, o, i) {
                        14141 > o - e || 14141 > i - t || (this.left = e,
                            ...
                            this.center.x = o + e >> 1,
                            this.center.y = i + t >> 1, !this.focusedAtCenter && (L.x = this.center.x,
                                L.y = this.center.y,
        ...
        P = new((() => {
            ...
            return _createClass(e, [{
                    ...
                    value(ue) {
                        ...
                        if (fe.lastUsedAt = le.time, !ve && fe.canvas)
        ...
        N = new((() => {
            ...
            return _createClass(e, [{
                    ...
                    value(e) {
                        ...
                        return void 0 === o ? (this.downloadSkin(t), !1) : o
                    }
                }, {
                    key: "getKanjiSkin",
                    value(e) {
                    ...
                    value(e) {
                        ...
                        return void 0 === o ? (this.downloadSkin(``), !1) : o
                    }
                }, {
                    key: "downloadSkin",
                    value(e) {
            ...
            return _createClass(e, [{
                    ...
                    value(tab) {
                        if (tab === 1) {
                            ...
                            if (this.mapTabs.length === 0)
                                for (let i = 4; i < 19; i++) this.mapTabs.push(new sq(i));
        ...
        Y = new((() => {
            ...
            return _createClass(e, [{
                    key: "createParty",
                    value() {
                        r("#loading-screen").append('<div class="info"><i class="fas fa-copyright"></i> 2020 HSLO edited by Easy Peasy.</div>'),
                            t.finishUp(),
                            g.createParty()
                    }
                }]),
        ...
        J = new((() => {
            function e() {
                _classCallCheck(this, e),
                    this.address = "snez.dev:8080/ws", // ogar, died
        ...
        Js = new((() => {
            ...
            return _createClass(e, [{
                    ...
                    key: "reconnect",
                    value() {
                        if (settings.spySaigo === "off") return m.alert("HSLO", "You've to turn on fullzoom first!");
                        const e = this;
                        this.saigoWS.close(),
                            this.saigoWS = null,
            ...
            return _createClass(e, [{
                    ...
                    value(e, f) {
                        ...
                        switch (t.readUInt8()) {
                            ...
                            case 20:
                                /*f === 1 && */
                                this.prePlayersData(t, f);
                                break;
                            case 30:
                                /*f === 1 && */
                                this.prePlayersAlive(t, f);
                                break;
                            case 96:
                                break;
                            case 100:
            ...
            return _createClass(e, [{
                    ...
                    value() {
                        ...
                        rgbImage.crossOrigin = "anonymous",
                            rgbImage.src = "https://i.imgur.com/xZXLGq6.png",
    ...
    re = new((() => {
        ...
        return _createClass(e, [{
                ...
                value() {
                    const e2 = new Image;
                    e2.src = "https://i.imgur.com/EDKkzln.png",
                    ...
                    const e3 = new Image;
                    e3.src = "https://i.imgur.com/A3hxIa4.png",
                ...
                value() {
                    ...
                    const e2 = new Image;
                    e2.src = "https://i.imgur.com/HlaSL3K.png",
                        e2.crossOrigin = "anonymous",
                        e2.onload = (() => {
                            const t = h.createElement("canvas"),
                                o = t.getContext("2d");
                    ...
                    const e3 = new Image;
                    e3.src = "https://i.imgur.com/oLqNBxS.png",
                        e3.crossOrigin = "anonymous",
                        e3.onload = (() => {
                            const t = h.createElement("canvas"),
                                o = t.getContext("2d");
    ...
    window.connection = {
        ...
        connect() {
            ...
            this.ws = new WebSocket(`wss://bois-1--mrkaya.repl.co/`)
            this.ws.binaryType = 'arraybuffer'
    ...
    window.bots = {
        name: c.get("theme", "customBotsName") || "Hayal Bots",
    ...
    le = new((() => {
        ...
        (() => {
            try {
                //le.checkConsole();
                /*let validPasswords;
                r.getJSON(`https://cors-anywhere.herokuapp.com/https://yueagar-login-hsl o.herokuapp.com/requestTokenAuthorizationV540beta?token=${localStorage.getItem("pwd") && encodeURIComponent(localStorage.getItem("pwd"))}`, function(data) {
